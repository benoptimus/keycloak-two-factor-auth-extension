...
@JBossLog
public class SmsOtpFormAuthenticator implements Authenticator {

	private static final String MOBILE_NUMBER_FIELD = "mobile_number";
	private static final String TPL_CODE = "sms-code-form.ftl";
    
    private final KeycloakSession session;

    public SmsOtpFormAuthenticator(KeycloakSession session) {
